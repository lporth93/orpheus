...
There is currently a class for computing higher-order aperture mass and aperture counts
...
Each of the above classes is a sub-class of the base class DirectEstimator, so they have a number of
